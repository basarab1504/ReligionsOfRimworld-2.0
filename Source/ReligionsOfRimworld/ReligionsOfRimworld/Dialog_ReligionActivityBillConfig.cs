...
{
    public class Dialog_ReligionActivityBillConfig : Window
    {
        ...
        public Dialog_ReligionActivityBillConfig(Bill_ReligionActivity bill, IntVec3 billGiverPos)
        {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Listing_Standard listing_Standard3 = listing_Standard.BeginSection((float)Dialog_ReligionActivityBillConfig.StoreModeSubdialogHeight);
            ...
            listing_Standard.Gap(12f);
            Listing_Standard listing_Standard4 = listing_Standard.BeginSection((float)Dialog_ReligionActivityBillConfig.WorkerSelectionSubdialogHeight);
            ...
            Rect rect5 = rect4;
            rect5.yMin = rect5.yMax - (float)Dialog_ReligionActivityBillConfig.IngredientRadiusSubdialogHeight;
            ...
            ThingFilterUI.DoThingFilterConfigWindow(rect6, ref this.thingFilterScrollPosition, this.bill.ingredientFilter, this.bill.FixedingredientFilter, openMask, forceHiddenDefs, forceHiddenSpecialFilters, false, premultipliedSmallIngredients, this.bill.Map);
        ...
        private IEnumerable<Widgets.DropdownMenuElement<Pawn>> GeneratePawnRestrictionOptions()
        {
            ...
            IEnumerable<Pawn> pawns = PawnsFinder.AllMaps_FreeColonists.Where(x => x.GetReligionComponent().Religion == bill.AssignedReligion);
